...
namespace HorrorGame.UI.Readouts
{
    ...
    /// </para>
    /// <para>
    /// <b>The 전리품 rows are gone.</b> This struct used to carry three of them —
    /// whether the dead player could see the pile they dropped, what it was worth in
    /// credits, and how far away it was — because §08 handed §09 that exact cruelty.
    /// DESCENT-PIVOT §7 step 7 deleted the loot and the credits, so a ghost has no pile
    /// to be tormented by. Do not re-add them: there is nothing to drop and nothing to
    /// price, and a race elimination is 탈락 rather than a loss of property.
    /// </para>
    /// </summary>
    public readonly struct GhostReadout
    {
        ...
        {
            get { return new GhostReadout(false, 0f, 0f, 0, GhostSignalFailure.None); }
        }
